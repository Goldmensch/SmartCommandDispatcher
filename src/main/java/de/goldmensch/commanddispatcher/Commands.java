...
public final class Commands {
    ...
    public static boolean checkPermission(@NotNull CommandSender sender, @NotNull Optional<String> posPermission) {
        return posPermission.isEmpty()
                || sender.hasPermission(posPermission.get());
    }
